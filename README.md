...
OpenAI · Meta · Anthropic이 2026년 상반기에 공개한 **사내 데이터 분석 에이전트 구축 사례**의 원문과 비교 분석입니다. 클론해서 Claude Code나 Codex로 질의응답하는 용도로 만들었습니다.
...
원문 전체가 repo에 있어 클론한 디렉터리에서 바로 질문할 수 있습니다.
